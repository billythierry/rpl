    ...
    <div class="main">
        ...
        <section class="products">
            ...
            <div class="cart-total">
                ...
                <div class="button">
                    <form method="post">
                        <button type="submit" name="empty_cart" class="btn" onclick="return confirm('are you sure to empty your chart')">empty cart</button>
                    </form>
                    <a href="checkout.php" class="btn">procceed to checkout</a>
                </div>
            </div>
            <?php } ?>                           
        </section>
