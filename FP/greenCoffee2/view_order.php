<?php
    ...
    if (isset($_POST['cancle'])) {
        $update_order = $conn->prepare("SELECT * FROM `orders` SET status = ? WHERE id=?");
...
<body>
    ...
    <div class="main">
        ...
        <div class="title2">
            <a href="contact.php">home </a><span>/ order detail</span>
        </div>
        <section class="order-detail">
                <div class="title">
                    <img src="img/download.png" class="logo">
                    <h1>order detail</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci, facilis error porro maxime odit molestiae nihil sequi hic fuga officia odio. Nulla tempora quaerat tempore molestiae quia inventore fugiat aut!</p>
                </div>
                    ...
                    <div class="box">
                        ...
                        <div class="col">
                            ...
                            <?php if ($fetch_order['status']=='canceled'){?>
                                <a href="checkout.php?get_id=<?= $fetch_product['id']; ?>" class="btn">order
                                again</a>
                            <?php }else{ ?>
                                <form method="post">
