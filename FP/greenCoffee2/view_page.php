<?php
    ...
    if (isset($_POST['add_to_cart'])) {
        ...
        if ($varify_cart->rowCount() > 0) {
            $warning_msg[] = 'product already exist in your wishlist';
        }else if ($$max_cart_nun->rowCount() > 20) {
            ...
            <form method="post">
                ...
                <div class="detail">
                    ...
                    <div class="product-detail">
                        ...
                        Beatae corporis nemo molestias. Corporis perspiciatis a libero, 
                        reprehenderit iusto eos quas quisquam blanditiis alias ullam quasi minus 
                        ratione sequi adipisci similique.</p>
                    </div>
